...
namespace EasyRemote.Views
{
    public partial class JobsList : System.Windows.Controls.UserControl
    {
        ...
        {
            ViewModel = viewModel; // Correction de la casse pour correspondre au type défini  
        ...
        private void AddJob(object sender, System.Windows.RoutedEventArgs e)
        {
            if (sender is System.Windows.Controls.Button button)
            {
                ...
                if (jobEdit.ShowDialog() ?? false)
                {

                    ViewModel.Configuration.AddJob(selectedJob);
                }
            }
        }
        ...
        private void RunSelectedJobs_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            ViewModel.RunCommandRun([.. selectedJobs.Select(j => j.Name)]);
